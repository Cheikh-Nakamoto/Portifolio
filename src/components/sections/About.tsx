    ...
    >
      ...
      <div className="container mx-auto max-w-6xl relative z-10">
        ...
        >
          ...
          <motion.div variants={itemVariants}>
            <h3 className="text-3xl md:text-4xl font-bold text-center mb-10 gradient-text">
              Mes valeurs
            </h3>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-4xl mx-auto">
                {siteConfig.certifications.map((cert) => (
                  <motion.div
                    ...
                    className="glass-strong p-6 rounded-2xl border-2 border-secondary/30 hover:border-secondary transition-all duration-300 hover:shadow-[0_0_20px_rgba(189,0,255,0.2)] group"
                  >
                    <div className="flex items-start space-x-4">
                      ...
                      <div className="flex-1">
                        ...
                        {cert.url && cert.url !== '#' && (
                          <a
                            ...
                            className="text-accent hover:text-accent/80 font-semibold text-sm mt-2 inline-block transition-colors duration-300"
                          >
          ...
          {siteConfig.blockchainActivities && (
            <motion.div variants={itemVariants}>
              ...
              {siteConfig.blockchainActivities.featuredHackathon && (
                <Card hover className="max-w-4xl mx-auto mb-8 border-2 border-secondary/30 hover:shadow-[0_0_25px_rgba(189,0,255,0.15)] transition-shadow duration-300">
          ...
          <motion.div variants={itemVariants}>
            ...
            <div className="glass-strong p-8 rounded-3xl max-w-4xl mx-auto neon-border hover:shadow-[0_0_20px_rgba(0,229,255,0.1)] transition-shadow duration-300">
